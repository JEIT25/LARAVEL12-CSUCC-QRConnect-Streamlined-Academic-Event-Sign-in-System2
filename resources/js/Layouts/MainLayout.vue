    ...
    <div class="flex min-h-screen">
        <!-- Sidebar is hidden by default and shown when isSidebarOpen is true -->
                ...
                <div class="flex-1">
                    ...
                    <main class="p-0">
            <!-- Success Message -->
                    <div class="fixed left-0 right-0 mb-4 border rounded-md shadow-md border-green-200 bg-green-100 p-2 text-center text-black-100 font-semibold" v-if="successMess">
                        {{ successMess }}
                    </div>
