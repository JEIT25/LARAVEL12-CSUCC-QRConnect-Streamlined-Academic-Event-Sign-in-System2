        ...
        <!-- Sidebar is hidden by default and shown when isSidebarOpen is true -->
                ...
                <button v-if="!isSidebarOpen && page.props.user" @click="toggleSidebar"
                    ...
                    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" width="34" height="34">
                        <path opacity="0.5" d="M12 22C7.29 22 4.93 22 3.46 20.54C2 19.07 2 16.71 2 12C2 7.29 2 4.93 3.46 3.46C4.93 2 7.29 2 12 2C16.71 2 19.07 2 20.54 3.46C22 4.93 22 7.29 22 12C22 16.71 22 19.07 20.54 20.54C19.07 22 16.71 22 12 22Z" fill="#1C274C"></path>
                        <path d="M18 8.75H6C5.59 8.75 5.25 8.41 5.25 8C5.25 7.59 5.59 7.25 6 7.25H18C18.41 7.25 18.75 7.59 18.75 8C18.75 8.41 18.41 8.75 18 8.75Z" fill="#1C274C"></path>
                        <path d="M18 12.75H6C5.59 12.75 5.25 12.41 5.25 12C5.25 11.59 5.59 11.25 6 11.25H18C18.41 11.25 18.75 11.59 18.75 12C18.75 12.41 18.41 12.75 18 12.75Z" fill="#1C274C"></path>
                        <path d="M18 16.75H6C5.59 16.75 5.25 16.41 5.25 16C5.25 15.59 5.59 15.25 6 15.25H18C18.41 15.25 18.75 15.59 18.75 16C18.75 16.41 18.41 16.75 18 16.75Z" fill="#1C274C"></path>
                    </svg>
                </button>
                ...
                <aside v-if="isSidebarOpen && page.props.user"
                    class="fixed w-64 overflow-auto bg-slate-950 p-4 pt-10 min-h-screen shadow-md border-r-4 border-yellow-500 z-100">
                    <!-- Administrator Info Section -->
                    <div class="flex flex-col items-center ml-2 mt-9 mb-7">
                        <svg fill="#ffd333" height="100px" width="100px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                            <path
                        ...
                        <div class="text-yellow-300 text-center">
                            <p class="font-thin pt-9 text-white text-xl">{{ page.props.user.fname }} {{ page.props.user.lname }}</p>
                    ...
                    <ul class="flex flex-col w-full space-y-2">
                        <li class="flex items-center w-full bg-slate-800 hover:bg-slate-700 rounded-md transition duration-200 ease-in-out p-4">
                        ...
                        <li class="flex items-center w-full bg-slate-800 hover:bg-slate-700 rounded-md transition duration-200 ease-in-out p-4">
                            ...
                            <Link class="text-yellow-300 hover:text-white pl-4 w-full" href="/module3">My Account</Link>
                        </li>
                    </ul>
                </aside>
            ...
            <!-- Success Message -->
                    <div class="mb-4 border rounded-md shadow-md border-green-200 bg-green-100 p-2 text-center text-black-100 font-semibold" v-if="successMess">
                        {{ successMess || 'Welcome, Facilitator! Your login was successful.' }}
                    </div>
