<template>
    <div class="flex min-h-screen">
        ...
        <button v-if="!isSidebarOpen && page.props.user" @click="toggleSidebar"
            class="fixed top-20 left-4 bg-yellow-500 hover:bg-yellow-600 text-white p-2 rounded-md z-50">
            <!-- Arrow icon (to open the sidebar) -->
        ...
        <button v-if="isSidebarOpen && page.props.user" @click="toggleSidebar"
            class="fixed top-20 left-52 bg-red-500 hover:bg-red-600 text-white p-2 rounded-md z-50">
        ...
        <aside v-if="isSidebarOpen && page.props.user"
            ...
            <ul class="flex flex-col w-full space-y-2"> <!-- Add space between items -->
                ...
                <li
                    ...
                    <Link class="text-yellow-300 hover:text-white w-full pl-4" href="/events">My Events</Link>
                </li>
        ...
        <div class="flex-1">
            ...
            <main class="p-0">
                <div class="mb-4 border rounded-md shadow-md border-green-200 bg-green-100 p-2 text-center text-black-100 font-semibold"
                    v-if="successMess">
                    {{ successMess }}
                </div>
...
<style scoped>
.dark-blue {
    background-color: rgb(94, 118, 145) !important;
}
