            ...
            <table class="min-w-full bg-white border border-gray-200 rounded-lg shadow-md">
                ...
                <tbody>
                    <tr v-for="facilitator in facilitator_accs" :key="facilitator.id"
                        ...
                        <!-- Account Status -->
                        <td class="py-2 px-4">
                            <span v-if="facilitator.acc_status === 'active'"
                                class="text-green-500 font-medium">Active</span>
                            <span v-else class="text-red-500 font-medium">Disabled</span>
                        </td>
                        ...
                        <td class="py-2 px-4">
                            ...
                            <Link v-if="facilitator.acc_status === 'disabled'"
                                :href="`/users/${facilitator.user_id}/active`" class="btn-success mr-3 rounded"
                                as="button" method="post">
                            Activate
                            </Link>

                            <Link v-else :href="`/users/${facilitator.user_id}/disabled`"
                                class="btn-primary py-1 px-3 rounded mr-2" as="button" method="post">
                            Disable
                            </Link>

                            <!-- Delete Button -->
                            <Link :href="`/users/${facilitator.user_id}`" class="btn-error text-white py-1 px-3 rounded"
