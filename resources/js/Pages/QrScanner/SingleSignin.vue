<template>
    <div class="flex flex-col-reverse md:flex-row md:h-30">
        ...
        <div class="md:w-1/2 flex justify-center items-center border-slate-500 p-4">
            <div class="flex flex-col items-center">
                ...
                <p class="text-lg text-left">
                    <strong v-if="props.event.program || props.event.year_level">Program & Year:</strong> {{
                    props.event.program }} {{ props.event.year_level}}<br>
                ...
                <div id="reader" class="w-full max-w-md h-64 bg-gray-200">
            ...
            <div class="w-full max-w-md">
                ...
                <div v-if="attendee_record" class="md:mt-4 bg-white p-4 rounded-lg shadow-md">
                    <div class="text-center capitalize">
                        ...
                        <p v-if="attendee_record.single_signin"><strong>Sign-in Time:</strong> {{
                            convertToLocalDateTime(attendee_record.single_signin) }}</p>
                        <p v-else><strong>Sign-in Time:</strong> {{ convertToLocalDateTime(single_signin) }}</p>
                    </div>
                </div>
...
const single_signin = ref(null); // In case of an existing attendee_record, this will be set with single_signin datetime value of the existing attendee_record
const props = defineProps({
    event: Object
});

function convertToLocalDateTime(isoDate) { // Function to format the datetime value of single_signin
...
onMounted(() => {
    const onScanSuccess = (qrCodeMessage) => {
        ...
        axios.post(`/events/${props.event.event_id}/qrscanner/single-signin`, {
            ...
            .then(response => {
                ...
                single_signin.value = response.data.single_signin;
